...
namespace KKHondaBackend.Controllers.Users
{
  ...
  public class UserController : Controller
  {
    ...
    [HttpGet("LeaderValidate")]
    public IActionResult LeaderValidate(int gid, string userName, string password)
    {

      var user = ctx.User.Where(x => (x.GId == 6 || x.GId == 14) && x.Username == userName && x.Password == password);
